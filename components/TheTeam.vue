<template>
  <div id="team">
    <div
      v-if="members.length"
      class="team-component mini-spacer"
    >
      <v-dialog
        v-model="memberDialogShow"
        ...
        <v-card v-if="memberDialog">
          ...
          <v-card-text>
            <v-row>
              <v-col
                cols="12"
                :sm="getDescription(memberDialog) ? 6 : 12"
              >
                <v-img
                  class="mt-10"
                  :height="300"
                ...
                <v-btn
                  v-if="memberDialog.instagramUrl"
                  block
                  class="mt-10"
                  elevation="0"
                  target="_blank"
                ...
                >
                  <i class="mdi mdi-2x mdi-instagram mr-5" /> Instagram
                </v-btn>
                <v-btn
                  v-if="memberDialog.facebookUrl"
                  block
                  class="mt-5"
                  elevation="0"
                  target="_blank"
                ...
                >
                  <i class="mdi mdi-2x mdi-facebook mr-5" /> Facebook
                </v-btn>
              </v-col>
              <v-col
                v-if="getDescription(memberDialog)"
                cols="12"
                sm="6"
              >
                <div
                  class="mt-10"
                  v-html="getDescription(memberDialog, true)"
                />
              </v-col>
            </v-row>
          </v-card-text>
      ...
      <v-container>
        ...
        <v-row class="mt-13">
          ...
          >
            <v-card
              elevation="0"
              class="team-card overflow-hidden mb-15"
